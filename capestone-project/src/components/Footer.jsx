...
import { footerImg, NavLogo } from "../utils/images";
            ...
            <ul className="footer_navList_ul">
              <li>
                <a
                  ...
                  href="https://www.linkedin.com/in/sblaze007/"
                >
                  Linkdin
                </a>
              </li>
              <li>
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://github.com/sblaze1998"
                >
                  GitHub
                </a>
              </li>
              <li>
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://instagram.com/sblaze_gaming"
                >
                  Instagram
                </a>
              </li>
